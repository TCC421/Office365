...
The script helps security teams rebuild the user’s activity timeline by collecting session ID-based audit logs in a consistent and easy-to-analyze format.

***Sample Output:***

Find the script output log file in CSV format that shows the result of the operation.

!\[Session ID-based Audit Logs](https://blog.admindroid.com/wp-content/uploads/2025/08/Session-ID-based-Audit-Logs.png)
